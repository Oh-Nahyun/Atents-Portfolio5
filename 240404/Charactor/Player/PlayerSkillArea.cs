...
public class PlayerSkillArea : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (coolTime < 0)
        {
            foreach (Enemy enemy in enemies) // 트기거 안에 있는 모든 적에게 데미지 주기
            {
...
/// 실습_240404
/// 1. Activate() 구현하기
/// 1-1. 활성화되면 skillTick마다 트리거 안에 있는 모든 적에게 finalPower만큼의 데미지를 준다.
/// 1-2. 칼의 이팩트는 켠다.
/// 1-3. 활성화 되어있는 동안 지속적으로 플레이어의 MP가 감소한다.
/// 1-4. 스킬 애니메이션 시작
